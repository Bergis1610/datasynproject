# Setting Up Datasets
Note that all datasets are downloaded on the tulipan/cybele computers (saved under /work/datasets) and on IDUN on /cluster/projects/itea_lille-idi-tdt4265/datasets.
